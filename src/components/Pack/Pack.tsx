...
export default function DenseTable() {
    ...
    return (
        <>
            ...
            <input
                type={'checkbox'}
                checked={isPrivatePacks}
                onChange={setPrivatePacks}
            />
                                    ...
                                    <>
                                        ...
                                        {deletedPackId === pack._id && (
                                            <Modal
                                                ...
                                                footer={
                                                    <tr key={pack._id}>
                                                        <button onClick={() => deleteCardPack(pack._id)}>
                                                            Yes
                                                        </button>
                                        ...
                                        <TableRow key={pack._id}>
                                            <TableCell align='left' key={pack._id}>
                                                {pack.name}
                                            </TableCell>
                                            <TableCell align='right'>{pack.cardsCount}</TableCell>
                                            <TableCell align='right'>{pack.updated}</TableCell>
                                            <TableCell align='right'>
                                                <button onClick={() => setUpdatingPackId(pack._id)}>
                                                    update
                                                </button>
                                                <button onClick={() => setDeletedPackId(pack._id)}>
                                                    del
                                                </button>
                                            </TableCell>
                                            <TableCell align='right'>
