...
import {
	...
	setCardsTC,
	updateCardTC
} from '../../reducers/r10-CardsReducer';
...
export default function Cards() {
	...
	const searchCallback = (value0: number, value1: number, text: string) => {
		dispatch(
			setCardsTC(cardsPackId, value1, value0, page, pageCount, text, sortCards)
		);
	};
				...
				<Modal
					...
					content={
						<div>
							...
							{'Enter your answer'}
							<div>
								<textarea value={answer} onChange={createAnswer}>
									{'Enter your answer'}
								</textarea>
							</div>
						</div>
								...
								return (
									<>
										...
										<TableRow key={card._id}>
											...
											<TableCell align='right'>
												<button onClick={() => setUpdatingCardId(card._id)}>
													update
												</button>
												<button onClick={() => setDeletedCardId(card._id)}>
													del
												</button>
											</TableCell>
										</TableRow>
